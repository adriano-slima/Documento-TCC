...
const EditarCliente = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axiosInstance.put(`/api/clientes/${id}/`, cliente);
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="pt-16 px-6 ml-0 md:ml-64 mt-4 transition-all max-w-7xl mx-auto">
                <div className="flex items-center text-sm text-gray-600 mb-6">
                    <span onClick={() => handleCancel()} className="cursor-pointer hover:text-blue-600">Lista de Clientes</span>
                    <span className="mx-2">/</span>
                    <span className="text-gray-900">Editar Cliente</span>
                </div>
